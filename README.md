...
- **A fighter remembers what worked.** When a throw kills, the throw that did it and the one before it are kept together as a named pair — a verb and an animal, LEAPING BADGER, CLOSING EEL — and from then on it will sometimes open with the first and follow with the second. Only a champion keeps its palette; everyone else starts empty, so a long reign is a fighter carrying more and more of what it has already got away with. The champion's palette is listed under the scoreboard.
