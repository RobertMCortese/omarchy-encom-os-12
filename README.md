...
- **One champion goes through.** At the end of a round the survivor with the most points carries its name and its whole record into the next one, marked with a chevron; everyone else is a new program with nothing to its name. So the champion is the only thing in the arena that accumulates, and the only one with anything to lose.
